...
im2pix is a tool to convert image to pseudo pixel art in R. It's a reduced version of [Nathan Harper's Python script](https://github.com/nathanharper/phixelgator).  
